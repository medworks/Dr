	...
	<div class="container">
		...
		<header>
			<div class="sixteen columns">
                ...
                <div class="flags">
                	<a href="../../index.php?lang=en" class="tip" title="انگلیسی"><img src="../images/england-flag.png" alt="english"></a>
                	<a href="../../index.php?lang=fa" class="tip" title="فارسی"><img src="../images/iran-flag.png" alt="persian"></a>
                </div>
									...
									<a href="{$image}" data-rel="prettyPhoto[portfolio]">
										<div class="flip box fade">
											<div class="rollover">
												<div class="cube ltr">
													<figure class="front">
														<img src="{$image}" alt="{$gallery[$i]['subject']}">
													</figure>
													<section class="back">
														<div class="back-wrap">
